...
export const mockedFilms: T.Film[] = [
    {
      name: "A era do gelo 1",
      image: "https://i.ibb.co/FzqPkpj/eradogelo.png",
      description: "Vinte mil anos atrás, num mundo coberto de gelo, o mamute Manfred e a preguiça Sid resgatam um bebê humano órfão. Agora, os dois vão enfrentar muitas aventuras até devolver o filhote de gente à sua tribo, que migrou para um novo acampamento. ",
    ...
    },
    {
      ...
      description: "Contos sobrenaturais baseados nas histórias em quadrinhos 'Hellblazer'. O solitário Constantine tenta garantir seu lugar no paraíso enviando demônios de volta ao inferno, mas seu destino está ligado ao de Angela, uma policial que investiga o suposto suicídio de sua irmã gêmea.",
      categoryId: "4334932a-8f62-4c4e-a653-da4ac59d65f3"
    }, 
    {
